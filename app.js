...
(() => {
  ...
  function applyAppearance() {
    ...
    style.textContent=`:root{--oh-page:${appearance.background};--oh-button:${appearance.button};--oh-button-text:${contrastText(appearance.button)};--oh-ink:${dark?'#f2f1f6':'#292b3b'};--oh-muted:${dark?'#c4c2cf':'#686676'};--oh-surface:${dark?'#242735':'#ffffff'};--oh-line:${dark?'#45485b':'#e5e2eb'};--oh-soft:${dark?'#303447':'#f0eef6'}}
      ...
      #ourhome-v11 .hero{padding:30px;border-radius:24px;background:var(--oh-soft);margin:24px 0}#ourhome-v11 .hero-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap}#ourhome-v11 .hero h2{font-size:27px;margin:10px 0}#ourhome-v11 .hero-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:24px 0}#ourhome-v11 .hero-stat{background:var(--oh-surface)!important;color:var(--oh-ink)!important;padding:18px;border-radius:16px}#ourhome-v11 .hero-stat strong{display:block;margin-top:9px;font-size:23px;overflow-wrap:anywhere;color:var(--oh-ink)!important;-webkit-text-fill-color:var(--oh-ink)!important;background:none!important}#ourhome-v11 .hero-stat small{color:var(--oh-muted)!important;-webkit-text-fill-color:var(--oh-muted)!important}#ourhome-v11 .hero h2,#ourhome-v11 .hero p strong{color:var(--oh-ink)!important;-webkit-text-fill-color:var(--oh-ink)!important}
